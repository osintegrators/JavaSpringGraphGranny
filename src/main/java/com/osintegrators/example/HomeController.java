...
public class HomeController {
	...
	@RequestMapping(value = "/findFriends/{name}", method = RequestMethod.GET)
	public @ResponseBody List<Address> findFriends(@PathVariable String name) {
	        logger.debug("in findFriends method");
	       return addressService.findFriends(name);
	}
